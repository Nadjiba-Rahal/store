// Algeria's 69 wilayas — updated per Loi 26-06 (April 2026), which created
// 11 new wilayas (59-69) from former daïras in the High Plateaus and south,
// on top of the 58 established by Loi 19-12 (December 2019).
...
export function wilayaLabel(code: string): string {
